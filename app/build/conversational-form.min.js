    ...
    var e = function() {
        ...
        return t.lerp = function(t, e, n) {
            ...
            return e.click = "ontouchstart" in window ? "touchstart" : "click", e.mousedown = "ontouchstart" in window ? "touchstart" : "mousedown", e.mouseup = "ontouchstart" in window ? "touchend" : "mouseup", e.mousemove = "ontouchstart" in window ? "touchmove" : "mousemove", e[t]
                ...
                // Added https to front of cloudfare link
            void 0 === e && (e = "emojify"), void 0 === n && (n = "https://cdnjs.cloudflare.com/ajax/libs/emojify.js/1.1.0/js/emojify.min.js");
            var i = document.head || document.getElementsByTagName("head")[0],
                o = document.createElement("script");
                // disabled function here by adding the display="none". Needed to do this because it was taking too long to reload.
            o.type = "text/javascript", o.async = !0, o.defer = !0, display="none", o.onload = function() {
...
! function(t) {
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "active", {
            ...
            var e = this;
            clearTimeout(this.animateInFromReponseTimer), this.animateInFromReponseTimer = setTimeout(function() {
                e.animateElementsIn()
            }, 500)
...
! function(cf) {
    ...
    var Tag = function() {
        ...
        return Object.defineProperty(Tag.prototype, "type", {
            ...
            this.defaultValue = this.domElement.value, this.questions = null, this.findAndSetQuestions(), this.findConditionalAttributes()
            ...
            if (t.length > 0) {
                ...
                for (var e in t)
                    if (t.hasOwnProperty(e)) {
                        var n = t[e];
                        if (-1 !== n.name.indexOf("cf-conditional")) {
...
! function(t) {
    var e = function() {
        function e(e) {
            this.elements = e.elements, this._fieldset = e.fieldset, this._fieldset && this._fieldset.getAttribute("cf-questions") && (this.questions = this._fieldset.getAttribute("cf-questions").split("|")), t.ConversationalForm.illustrateAppFlow && console.log("Conversational Form > TagGroup registered:", this.elements[0].type, this)
        }
            ...
            switch (this._values = [], this._activeElements = [], n) {
                case "radio":
                    for (var i = [], o = !1, s = 0; s < t.controlElements.length; s++) {
                        ...
                        i.push(r), a == r.referenceTag && (r.checked && (this._values.push(a.value), this._activeElements.push(a)), !o && r.checked && (o = !0))
                    }
                    e = o;
                    break;
                case "checkbox":
...
! function(t) {
    ...
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "active", {
            ...
            var o = e.detail;
            this.inputElement.setAttribute("data-value", this.inputElement.value), this.inputElement.value = "", this.el.setAttribute("error", ""), this.disabled = !0, this.inputElement.setAttribute("placeholder", o.errorText || this._currentTag.errorMessage), clearTimeout(this.errorTimer), this.submitButton.classList.remove("loading"), this.errorTimer = setTimeout(function() {
...
! function(t) {
    ...
    var e = function(e) {
        function n(t) {
            var n = e.call(this, t) || this;
            return n._list = t.list, n._tag = t.tag, n.textEl = n.el.getElementsByTagName("text")[0], n.updateThumbnail(n.image), n
        }
        return __extends(n, e), Object.defineProperty(n.prototype, "tag", {
            ...
            set: function(t) {
                t ? (this.el.offsetWidth, this.el.classList.add("show")) : this.el.classList.remove("show")
            },
            enumerable: !0,
            configurable: !0
            ...
            if (this.responseLink && this.isRobotReponse) {
                n = n.split("{previous-answer}").join(this.responseLink.parsedResponse);
                for (var s = this._list.getResponses(), r = 0; r < s.length; r++) {
                    var a = s[r];
                    a !== this && a.tag && (a.tag.id && (n = n.split("{" + a.tag.id + "}").join(a.tag.value)), a.tag.name && (n = n.split("{" + a.tag.name + "}").join(a.tag.value)))
                }
            }
            return -1 != n.indexOf("contains-image") && this.textEl.classList.add("contains-image"), this.textEl.innerHTML = n, this.parsedResponse = n, this.textEl.removeAttribute("thinking"), this.textEl.removeAttribute("value-added"), setTimeout(function() {
            ...
            this.image = n.image, this.response = "", this.isRobotReponse = n.isRobotReponse, e.prototype.setData.call(this, n), setTimeout(function() {
                i.setValue(), i.updateThumbnail(i.image), i.isRobotReponse || null != n.response ? setTimeout(function() {
                    return i.setValue({
                        text: n.response
                    })
    ...
    var e = function(e) {
        ...
        return __extends(n, e), n.prototype.onInputHeightChange = function(e) {
            ...
            this.currentResponse && (this.currentResponse.disabled = !1), this.containsTagResponse(i) && !e.detail.ignoreExistingTag ? this.onUserWantsToEditTag(i) : setTimeout(function() {
                ...
                n.currentUserResponse && (n.currentUserResponse.setLinkToOtherReponse(t), t.setLinkToOtherReponse(n.currentUserResponse)), setTimeout(function() {
            ...
            for (var e = 0; e < this.responses.length; e++) {
                ...
                if (!n.isRobotReponse && n.tag == t && !t.hasConditions()) return !0
            }
            return !1
            ...
            for (t += t % 2; this.responses.length > t;) {
        ...
        return Object.defineProperty(ConversationalForm.prototype, "createId", {
            ...
            if (cf_1.Helpers.setEmojiLib(), this.loadExternalStyleSheet) {
                var t = document.head || document.getElementsByTagName("head")[0],
                    ...
                    n = "build/conversational-form.min.css" // replaced the below line with a local copy
